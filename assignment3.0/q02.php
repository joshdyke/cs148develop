...
//    $results = $thisDatabaseReader->testQuery($query, "", 1, 1, 2, 0, false, false);
    ...
    print '<h1>SELECT DISTINCT fldDays, fldStart FROM tblSections JOIN tblTeachers ON tblTeachers.pmkNetId = tblSections.fnkTeacherNetId JOIN tblCourses ON tblCourses.pmkCourseId = tblSections.fnkCourseId WHERE tblTeachers.fldLastName = "Snapp" ORDER BY fldStart;<h1>';
    print '<table class ="assignment3">';
    print '<tr><th>Days</th><th>Start Time</th></tr>';
