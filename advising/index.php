...
$columns = 17;
    ...
    $query = 'SELECT * ' .
             'FROM tbl4YP ' .
             'JOIN tblSemesterPlan ON tbl4YP.pmkPlanId=tblSemesterPlan.fnkPlanId ' .
             'JOIN tblSemester ON tblSemesterPlan.fnkPlanId=tblSemester.fnkPlanId ' .
             'AND tblSemesterPlan.fnkTerm=tblSemester.fnkTerm ' . 
             'AND tblSemesterPlan.fnkYear=tblSemester.fnkYear ' .
             'JOIN tblCourses ON tbl4YP.fldMajor=tblCourses.fldDept';

    $results = $thisDatabaseReader->testQuery($query, "", 0, 2, 0, 0, false, false);
    $results = $thisDatabaseReader->select($query, "", 0, 2, 0, 0, false, false);
    
    print '<table class ="Test Four Year Plan">';
    print '<tr><th>Wrong</th><th>Wrong</th><th>Wrong</th><th>Wrong</th><th>Wrong</th></tr>';
